...
{
    public record VerifyResetCodeCommand(VerifyResetCodeRequestDTO Request) : IRequest<ResponseHttp>;

    public class VerifyResetCodeCommandHandler : IRequestHandler<VerifyResetCodeCommand, ResponseHttp>
    {
        ...
        public async Task<ResponseHttp> Handle(VerifyResetCodeCommand request, CancellationToken cancellationToken)
        {
            try
            {
