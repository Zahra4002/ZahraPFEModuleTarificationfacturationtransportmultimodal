    ...
    public partial class InitCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-1111-1111-1111-aaaaaaaaaaaa"), false, "VAT-FR-20", "FR", "Seed", null, new DateTime(2026, 3, 19, 8, 51, 47, 521, DateTimeKind.Utc).AddTicks(597), null, null, true, false, null, null, null, "TVA France 20%", 5.5m, null, 20.0m, 2.1m, null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 0m },
                    { new Guid("aaaaaaaa-2222-2222-2222-aaaaaaaaaaaa"), false, "VAT-FR-55", "FR", "Seed", null, new DateTime(2026, 3, 19, 8, 51, 47, 521, DateTimeKind.Utc).AddTicks(610), null, null, true, false, null, null, null, "TVA France 5.5% (réduit)", 5.5m, null, 20.0m, 2.1m, null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 0m },
                    { new Guid("aaaaaaaa-3333-3333-3333-aaaaaaaaaaaa"), false, "VAT-FR-21", "FR", "Seed", null, new DateTime(2026, 3, 19, 8, 51, 47, 521, DateTimeKind.Utc).AddTicks(615), null, null, true, false, null, null, null, "TVA France 2.1% (super réduit)", 5.5m, null, 20.0m, 2.1m, null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 0m },
                    { new Guid("aaaaaaaa-4444-4444-4444-aaaaaaaaaaaa"), true, "VAT-TN-19", "TN", "Seed", null, new DateTime(2026, 3, 19, 8, 51, 47, 521, DateTimeKind.Utc).AddTicks(620), null, "{\"export\": true, \"sectors\": [\"agriculture\", \"education\"]}", true, false, null, null, null, "TVA Tunisie 19%", 7.0m, null, 19.0m, null, null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 0m },
                    { new Guid("aaaaaaaa-5555-5555-5555-aaaaaaaaaaaa"), true, "VAT-TN-07", "TN", "Seed", null, new DateTime(2026, 3, 19, 8, 51, 47, 521, DateTimeKind.Utc).AddTicks(625), null, "{\"sectors\": [\"hotels\", \"restaurants\"]}", true, false, null, null, null, "TVA Tunisie 7% (réduit)", 7.0m, null, 19.0m, null, null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 0m },
                    { new Guid("aaaaaaaa-6666-6666-6666-aaaaaaaaaaaa"), false, "VAT-FR-196", "FR", "Seed", null, new DateTime(2026, 3, 19, 8, 51, 47, 521, DateTimeKind.Utc).AddTicks(633), null, null, false, false, null, null, null, "Ancien taux TVA France 19.6%", 5.5m, null, 19.6m, 2.1m, null, new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2013, 12, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), 0m },
                    { new Guid("aaaaaaaa-7777-7777-7777-aaaaaaaaaaaa"), true, "VAT-EXPORT", "FR", "Seed", null, new DateTime(2026, 3, 19, 8, 51, 47, 521, DateTimeKind.Utc).AddTicks(641), null, "{\"proofOfExport\": true, \"documents\": [\"EX1\", \"invoice\"]}", true, false, null, null, null, "Exportation hors UE", null, null, 20.0m, null, null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 0m }
                });
